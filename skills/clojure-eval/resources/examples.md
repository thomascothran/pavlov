# devenv shell clj-nrepl-eval Examples
...
```bash
devenv shell clj-nrepl-eval -p 7888 <<'EOF'
(defn greet [name]
  (str "Hello, " name "!"))
...
devenv shell clj-nrepl-eval -p 7888 "(def message \"She said \\\"Hello!\\\" and waved\")"
```
...
devenv shell clj-nrepl-eval -p 7888 "(require 'clojure-mcp-light.hook :reload)"
```
...
devenv shell clj-nrepl-eval -p 7888 --reset-session
```
